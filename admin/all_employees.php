                    ...
                    <table class="table table-striped thead-dark table-bordered table-hover" id="myTable">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
                                <th>Surname</th> <?php if ($_SESSION["permission"] != 3) { ?>
                                    <th>Email</th>
                                    <th>Phone</th> <?php } ?>
                                <th>Gender</th> <?php if ($_SESSION["permission"] != 3) { ?>
                                    <th>Action</th>
                                <?php } ?>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['surname']; ?></td> <?php if ($_SESSION["permission"] != 3) {  ?>
                                    <td><?php echo $row['email']; ?></td>
                                    <td><?php echo $row['phone']; ?></td> <?php } ?>
                                <td><?php echo $row['gender']; ?></td> <?php if ($_SESSION["permission"] != 3) {  ?>
                                    <td>
                                        <a href="#samstrover<?php echo $row['id']; ?> " data-toggle="modal" class="btn btn-warning"><span class="fa fa-pencil"></span> View</a>
                                    <?php } ?>
                            </tr>
                            <?php
                        ...
                        if (isset($_GET['idx']) && is_numeric($_GET['idx'])) {
                            ...
                            ?>
                                <div class="alert alert-success strover" id="sams1">
                                    ...
                                    <strong> Successfully! </strong><?php echo 'Record Successfully deleted please refresh this page'; ?>
                                </div>
